...
train_dataset = CachedEgoDataset(cfg, train_zarr, rasterizer, preprocessed_path=preprocessed_dir, augmented = True)

import os, sys
sys.path.append( "/mnt/home/v_liuhaolan/haolan/l5kit/nmp/model")

from models import RasterizedTNTWithHistory
...
#        iter_bar.set_description(f"loss: {(loss_v)} loss(avg): {loss_average}")
    ...
    torch.save(model.state_dict(),"./ckpt/planning_tnt_{}.pt".format(epochs))
