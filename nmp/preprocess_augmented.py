...
preprocessed_dir = "/mnt/scratch/v_liuhaolan/augmented_v2/"
...
train_dataset = CachedEgoDataset(cfg, train_zarr, rasterizer, if_preprocess = False, preprocessed_path=preprocessed_dir,perturbation=perturbation, augmented = True)
