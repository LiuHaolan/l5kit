...
#        if self.training:
        if True:
            ...
            gt_map_tensor_full = batch_gaussian_tensor_obj(gt_goal_positions_pixels[:,1], gt_goal_positions_pixels[:,0], 112, 112, data_batch["ocg"], data_batch["obj_num"], batch_road_mask, sigma=2, device="cuda:0")
