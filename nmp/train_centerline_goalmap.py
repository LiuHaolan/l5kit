...
# get config
cfg = load_config_data("/mnt/home/v_liuhaolan/haolan/l5kit/nmp/centerline-config.yaml")

# rasterisation and perturbation
rasterizer = build_rasterizer(cfg, dm)

preprocessed_dir = "/mnt/scratch/v_liuhaolan/preprocessed_centerline"

from l5kit.dataset import CachedEgoDataset

train_zarr = ChunkedDataset(dm.require(cfg["train_data_loader"]["key"])).open()
train_dataset = CachedEgoDataset(cfg, train_zarr, rasterizer, preprocessed_path=preprocessed_dir, centerline = True)
...
from model.models import RasterizedTNTCenterline
model = RasterizedTNTCenterline(
...
val_dataset = EgoDataset(cfg, val_zarr, rasterizer, centerline=True)
...
for epochs in range(epoch_num):
    ...
    for step,batch in enumerate(iter_bar):
        ...
        if step > 0 and step%5000 == 0:
            ...
            torch.save(model.state_dict(),"./planning_centerline_{}_{}.pt".format(epochs,step))
