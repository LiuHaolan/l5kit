...
preprocessed_dir = "/mnt/scratch/v_liuhaolan/preprocessed_128/"
...
train_dataset = CachedEgoDataset(cfg, train_zarr, rasterizer, if_preprocess = False, preprocessed_path=preprocessed_dir,perturbation=perturbation)
